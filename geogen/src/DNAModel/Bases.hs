...
spineUnit =
  prependName "DeoxyP-"
    <$> [ Atom "C2'"    Carbon     (V3 -2.251 8.158 -1.870)
        ...
        , Atom "DummyC" Carbon     (V3 -2.465 5.399 -0.246)
        , Atom "DummyC" Carbon     (V3 -6.481 5.091 1.450)
        , Atom "DummyO" Oxygen     (V3 -1.665 9.588 -1.679)
        ]
...
guanine =
  prependName "G-"
    <$> [ Atom "C1'"    Carbon   (V3 -2.477 5.399 0.000)
        ...
        , Atom "DummyO" Oxygen   (V3 -2.944 5.842 -1.237)
        , Atom "DummyC" Carbon   (V3 -3.101 6.244 1.027)
        ]
